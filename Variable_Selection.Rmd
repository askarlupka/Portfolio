...
levels(d$Country)
d$Country <- fct_collapse(d$Country, Other = c("Australia", "Austria", "Brazil", "Ca da", "Chi", "Croatia", "Denmark", "France", "Iraq", "Israel", "Italy", "Multiple", "Netherlands", "New Zealand", "Norway", "Other", "Scotland", "Spain", "UK", "Unspecified"), USA = "USA", Japan = "Japan")
levels(d$Country)
...
#Recode the blanks for season into Unknown

levels(d$season)
unique(d$season)
d$season <- forcats::fct_explicit_na(d$season, "Unknown")
unique(d$season)
levels(d$season)
...
#the null model always predicts "No" becuase this is the most frequent category of our expected outcome. 

measureACC(d$gg2c4, "No")
...
null_auc <- data.frame(matrix(1, nrow = 850, ncol = 1))

roc_null <- roc(d$gg2c4, null_auc[,1])
auc(roc_null)
